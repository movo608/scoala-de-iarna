...
use app\models\PostsCategoriesSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * PostsCategoriesController implements the CRUD actions for PostsCategories model.
 */
class PostsCategoriesController extends Controller
{
    ...
    {
        $searchModel = new PostsCategoriesSearch();
